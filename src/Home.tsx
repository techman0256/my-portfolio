        ...
        <div className="heroContainer flex-col space-y-[112px] mt-[62px] ">
            <div className="flex justify-between space-x-8">
                ...
                <div className="imageContainer flex flex-col items-center relative w-full sm:max-w-[457px] mx-auto ">
                    ...
                    <img className="absolute z-10 relative w-[100%]" src="heroImage.png" alt="" />
                    <img className="absolute z-20 left-[77%] top-[40%] sm:top-[35%] md:top-[50%] lg:top-[55%] w-[20%]" src="Dots.png" alt="" />
            ...
            <div className="quote flex flex-col w-fit mx-auto">
